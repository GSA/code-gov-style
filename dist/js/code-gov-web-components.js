  ...
  function (_HTMLElement) {
    ...
    _createClass(GovBanner, [{
      ...
      value: function getSvgUri(svgString) {
        return "data:image/svg+xml;utf8,".concat(svgString);
